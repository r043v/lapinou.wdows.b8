...
unsigned long _stdcall VideoForWindowsVersion(void);
LONG VFWAPI InitVFW(void);
LONG VFWAPI TermVFW(void);
#if !defined(__mmsystem_h__)
#include <mmsystem.h>
#endif
#ifndef MKFOURCC
...
#endif
#define AVIIF_LIST	1
#define AVIIF_TWOCC	2
#define AVIIF_KEYFRAME	16
...
#define VIDCF_QUALITY	1 
#define VIDCF_CRUNCH	2 
#define VIDCF_TEMPORAL	4 
#define VIDCF_COMPRESSFRAMES 8 
...
#define ICCOMPRESSFRAMES_PADDING	1
typedef struct {
	DWORD dwFlags; 
	LPBITMAPINFOHEADER lpbiOutput; 
	LPARAM lOutput; 
...
#define ICINSTALL_DRIVER 2 
#define ICINSTALL_HDRV 4 
#define ICINSTALL_DRIVERW 0x8002 
#define ICMF_CONFIGURE_QUERY 1
#define ICMF_ABOUT_QUERY 1
...
#define ICConfigure(hic,hwnd)  ICSendMessage(hic,ICM_CONFIGURE,(DWORD)(UINT)(hwnd),0)
#define ICGetState(hic,pv,cb)  ICSendMessage(hic,ICM_GETSTATE,(DWORD)(LPVOID)(pv),(DWORD)(cb))
#define ICSetState(hic,pv,cb)  ICSendMessage(hic,ICM_SETSTATE,(DWORD)(LPVOID)(pv),(DWORD)(cb))
#define ICGetStateSize(hic)  ICGetState(hic,NULL,0)
static DWORD dwICValue;
#define ICGetDefaultQuality(hic) (ICSendMessage(hic,ICM_GETDEFAULTQUALITY,(DWORD)(LPVOID)&dwICValue,sizeof(DWORD)),dwICValue)
#define ICGetDefaultKeyFrameRate(hic)  (ICSendMessage(hic,ICM_GETDEFAULTKEYFRAMERATE,(DWORD)(LPVOID)&dwICValue,sizeof(DWORD)),dwICValue)
#define ICDrawWindow(hic,prc)  ICSendMessage(hic,ICM_DRAW_WINDOW,(DWORD)(LPVOID)(prc),sizeof(RECT))
...
#define ICCompressBegin(hic,lpbiInput,lpbiOutput) ICSendMessage(hic,ICM_COMPRESS_BEGIN,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput))
#define ICCompressQuery(hic,lpbiInput,lpbiOutput)  ICSendMessage(hic,ICM_COMPRESS_QUERY,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput))
#define ICCompressGetFormat(hic,lpbiInput,lpbiOutput)  ICSendMessage(hic,ICM_COMPRESS_GET_FORMAT,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput))
#define ICCompressGetFormatSize(hic,lpbi)  ICCompressGetFormat(hic,lpbi,NULL)
#define ICCompressGetSize(hic,lpbiInput,lpbiOutput)  ICSendMessage(hic,ICM_COMPRESS_GET_SIZE,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput))
...
#define ICDecompressBegin(hic,lpbiInput,lpbiOutput) ICSendMessage(hic,ICM_DECOMPRESS_BEGIN,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput))
#define ICDecompressQuery(hic,lpbiInput,lpbiOutput) ICSendMessage(hic,ICM_DECOMPRESS_QUERY,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput))
#define ICDecompressGetFormat(hic,lpbiInput,lpbiOutput) ((LONG) ICSendMessage(hic,ICM_DECOMPRESS_GET_FORMAT,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput)))
#define ICDecompressGetFormatSize(hic,lpbi) ICDecompressGetFormat(hic,lpbi,NULL)
#define ICDecompressGetPalette(hic,lpbiInput,lpbiOutput)  ICSendMessage(hic,ICM_DECOMPRESS_GET_PALETTE,(DWORD)(LPVOID)(lpbiInput),(DWORD)(LPVOID)(lpbiOutput))
#define ICDecompressSetPalette(hic,lpbiPalette)  ICSendMessage(hic,ICM_DECOMPRESS_SET_PALETTE,(DWORD)(LPVOID)(lpbiPalette),0)
#define ICDecompressEnd(hic) ICSendMessage(hic,ICM_DECOMPRESS_END,0,0)
static LRESULT VFWAPI
ICDecompressEx( HIC hic,DWORD dwFlags,LPBITMAPINFOHEADER lpbiSrc,
...
static __inline LRESULT VFWAPI ICDecompressExBegin(
	HIC hic,DWORD dwFlags,LPBITMAPINFOHEADER lpbiSrc,LPVOID lpSrc,
...
static __inline LRESULT VFWAPI ICDecompressExQuery( HIC hic,DWORD dwFlags,
	LPBITMAPINFOHEADER lpbiSrc,LPVOID lpSrc,int xSrc,int ySrc,int dxSrc,
	int dySrc,LPBITMAPINFOHEADER lpbiDst,LPVOID lpDst,int xDst,int yDst,
	int dxDst,int dyDst)
{
	ICDECOMPRESSEX ic;
	ic.dwFlags = dwFlags;
...
#define ICDRAW_QUERY 1 
#define ICDRAW_FULLSCREEN 2 
#define ICDRAW_HDC 4 
...
#define ICDrawQuery(hic,lpbiInput)  ICSendMessage(hic,ICM_DRAW_QUERY,(DWORD)(LPVOID)(lpbiInput),0L)
#define ICDrawChangePalette(hic,lpbiInput) ICSendMessage(hic,ICM_DRAW_CHANGEPALETTE,(DWORD)(LPVOID)(lpbiInput),0L)
#define ICGetBuffersWanted(hic,lpdwBuffers) ICSendMessage(hic,ICM_GETBUFFERSWANTED,(DWORD)(LPVOID)(lpdwBuffers),0)
...
#define ICDrawGetTime(hic,lplTime) ICSendMessage(hic,ICM_DRAW_GETTIME,(DWORD)(LPVOID)(lplTime),0)
#define ICDrawSetTime(hic,lTime)  ICSendMessage(hic,ICM_DRAW_SETTIME,(DWORD)lTime,0)
#define ICDrawRealize(hic,hdc,fBackground)  ICSendMessage(hic,ICM_DRAW_REALIZE,(DWORD)(UINT)(HDC)(hdc),(DWORD)(BOOL)(fBackground))
...
#endif
#else 
STDAPI AVIFileOpen (PAVIFILE * ppfile,LPCSTR szFile, UINT uMode,LPCLSID lpHandler);
#endif
#ifdef _WIN32
...
#endif
STDAPI_(BOOL) AVISaveOptions(HWND,UINT,int,PAVISTREAM *,LPAVICOMPRESSOPTIONS *); 
...
#define VHDR_DONE 1 
#define VHDR_PREPARED 2 
#define VHDR_INQUEUE 4 
#define VHDR_KEYFRAME 8 
